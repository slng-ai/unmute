...
func examplePackagePath(name string) string {
	switch name {
	case "remy", "safe_core", "daily_carrier", "simple-prompt", "typed_state", "typed_inputs", "prefetch_core", "terminal_step", "turn_listener", "turn_listener_gradium", "speechmatics_local", "speechmatics_listen", "realtime_live":
