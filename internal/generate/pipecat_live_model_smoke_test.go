...
// TestSmokeLiveModel drives the emitted live_model bot through the real
...
func TestSmokeLiveModel(t *testing.T) {
	...
	checkStreamingOutput(t, runPipecatSmokeScript(t, "live_model", nil, nil, harness+pipecatLiveModelScript))
}
