...
// token reaches the emitted body unchanged", and that was true when it was
// written. Backend commit 22e0d434 (2026-07-07, "vault phase 2") added the
// {{$NAME}} grammar to prompts and greetings and substituted org *variables*
// at dispatch; org secrets were never allowed there. Commit 39b119eb
// (2026-09-02, "Remove global variables") removed org variables and deleted
// that grammar from the template validator, so from that day a Vault token in
// a prompt is a syntax error at push. SlngTargetVerified was 2026-08-25, inside
// the window, which is how the early return outlived the feature. Re-read at
// 0957de04.
