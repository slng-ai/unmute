...
| one full release-readiness project | `examples/salon-concierge` | verification task, booking task group, four-agent handoffs, SQLite tools, Firecrawl MCP, cold manager transfer, browser audio, and inbound-only phone routes on both targets |
