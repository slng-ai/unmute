...
// ==1.10.0. Official services ship as pipecat-ai extras and take model/
...
var pipecatCatalog = []Entry{
	...
	},
	{
		...
		Notes: []string{"the WebSocket live service; the HTTP ElevenLabsSTTService needs a caller-supplied aiohttp session, which the generic builder has no slot for"},
	},
	{
	...
	},
	{
		...
		Call: &CallSpec{
			...
			// (services/openai/base_llm.py:383, pipecat 1.9.0 source read
			// 2026-09-11), so extra_headers and extra_body reach the SDK call
