...
<Note>
  Sharing a finished agent rather than changing the compiler? That is a
  template, it goes to
  [slng-ai/unmute-templates](https://github.com/slng-ai/unmute-templates), and
  the [Templates page](/start/templates#contribute-a-template) says what it
  carries. The five things below are for a change to Unmute itself.
</Note>
