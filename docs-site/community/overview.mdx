...
| A finished agent you want to share | [Templates](/start/templates#contribute-a-template) |
...
<Columns cols={2}>
  ...
  <Card title="Templates" icon="copy" href="/start/templates">
    Ready-made agents to clone and run, and how to add one of your own.
  </Card>
</Columns>
