...
The browser dev loop needs Docker with Compose. Check it before the quickstart:

```sh
docker compose version
```

You can write, validate, and compile a package without Docker. Phone routes
have their own local requirements on the [phone routes](/dev/telephony) page.
