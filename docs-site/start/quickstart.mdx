...
<Steps>
  <Step title="Scaffold a package">
    ...
    <Accordion title="Files created by unmute init">
      ...
      compiles to. Unmute compiles to three targets: Pipecat, LiveKit Agents,
...
<AccordionGroup>
  ...
  <Accordion title="Port already in use">
    ...
    `--bot-port`, `unmute dev` picks a free one and prints the URL. Either stop
    the run holding the port, or pass another one: `--port 8790` for the web
    page and `--bot-port 7890` for the agent.
  </Accordion>
</AccordionGroup>
