...
<Steps>
  <Step title="Scaffold a package">
    ...
    <Accordion title="Files created by unmute init">
      ...
      compiles to. Unmute compiles to four targets: Pipecat, LiveKit,
      SLNG or Twilio (see [targets](/targets/overview)); this scaffold picks
      LiveKit Agents. Their configuration pages list every supported key.
