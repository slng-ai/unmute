...
The two largest single costs we found on our own agent were both this shape: a
step that spent 23.3s and five model round trips collecting a phone number the
call already carried, and a caller saying "tomorrow" costing two chained tool hops
and 2.56s of silence.
