...
description: "Settings that speed up a call, why each one matters, and how to write them in agent.yaml."
...
the framework default no matter how short the authored silence window was. A
wait that stays flat and long, turn after turn, is usually the ceiling rather
than the floor.
...
in the same turn, or a tool at the end of one step and a task at the start of the next.
