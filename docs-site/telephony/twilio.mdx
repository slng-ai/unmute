...
on 2026-08-18. The transfer caller ID behaviour, the shape of a rejected transfer
leg, and the regional isolation notes come from a live inbound call and its Twilio
call logs on 2026-08-26. The account dashboard location of the Account SID and auth
token comes from this repository's generated runbooks; the Twilio pages name the two
...
<Columns cols={2}>
  ...
  <Card title="Your first phone call" icon="phone-incoming" href="/telephony/inbound-calls">
    Take a real call, once you deploy.
  </Card>
