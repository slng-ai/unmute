...
<Columns cols={2}>
  ...
  <Card title="Handoff" icon="arrow-right-left">
    ...
    **Cost:** nothing returns, so there is no result or automatic way back.
  </Card>
</Columns>
...
It uses tasks, a shared task group, direct handoffs, and human transfer in one
inbound-only project.
