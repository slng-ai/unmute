...
<Note>
  ...
  runs none of your package's code, so it has nowhere to check a shape. The
  [Twilio target](/targets/twilio) refuses variables and shapes.
</Note>
