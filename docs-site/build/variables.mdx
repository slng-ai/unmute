...
Three steps, in that order. This page walks them, then covers the types you can
declare.
...
<Note>
  Skip this section until you need it. A shape is worth declaring when several
  fields always travel together and one tool fills all of them at once. Until
  then, separate variables are simpler to read and simpler to prompt.
</Note>
