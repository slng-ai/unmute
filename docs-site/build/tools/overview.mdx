...
| `inject` | no | `webhook:`, `local:`, and hosted `slng:`; authored values are scalars or placeholder strings. See [Variables](/reference/variables#passing-a-value-into-a-tool) |
