...
| a connection's `environment:` values | the <Tooltip tip="The phone company your number is with, such as Twilio or Telnyx.">carrier</Tooltip> account behind a phone route |
