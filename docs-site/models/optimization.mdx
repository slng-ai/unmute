...
to each binding. [Regional infrastructure](/models/regional-infrastructure)
...
the [Context Router](/models/context-router), and it is the one place where the
...
<Columns cols={2}>
  <Card title="Context Router" icon="gauge" href="/models/context-router">
  ...
  <Card title="Regional infrastructure" icon="globe-2" href="/models/regional-infrastructure">
