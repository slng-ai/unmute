...
`qwen/qwen3-32b` the four providers spanned 564 ms to 1261 ms at p50 and 739 ms to
7.3 s at p90, and latency did not predict correctness: the second-fastest spoke a
