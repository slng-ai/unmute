---
title: "Unmute"
description: "A declarative standard for voice agents. Describe the agent once, compile it to Pipecat, LiveKit, or SLNG."
...
<Columns cols={2}>
  ...
  <Card title="Four targets" icon="boxes" href="/targets/overview">
    The same package compiles to Pipecat, to LiveKit, and to SLNG. Same
    prompt, same tools, same behavior. A phone agent with one prompt can
    also compile to a Twilio ConversationRelay app.
  </Card>
</Columns>
