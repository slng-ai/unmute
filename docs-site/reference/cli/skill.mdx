...
Three skills are installed. `unmute` builds and maintains agent packages;
`unmute-manifest` interviews you about your company's approved choices and saves
the contract; `unmute-deploy` pushes a finished package to SLNG and reads back
what landed. Your assistant picks the one that matches what you ask for.

| Assistant | Reads |
|---|---|
| Claude Code | `.claude/skills/unmute/`, `.claude/skills/unmute-manifest/` and `.claude/skills/unmute-deploy/` |
| Codex | `.agents/skills/unmute/`, `.agents/skills/unmute-manifest/` and `.agents/skills/unmute-deploy/` |
| Cursor | `.agents/skills/unmute/`, `.agents/skills/unmute-manifest/` and `.agents/skills/unmute-deploy/` |
| GitHub Copilot | `.agents/skills/unmute/`, `.agents/skills/unmute-manifest/` and `.agents/skills/unmute-deploy/` |
...
| The agent compiles but has not been heard | compile checks and generates artifacts; it runs no conversation | use `unmute dev hotel-agent` for LiveKit or Pipecat, test the deployed SLNG agent, or call a hosted Twilio app |
