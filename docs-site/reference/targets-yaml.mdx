...
| `targets.<name>.provider` | string | yes | — | `livekit`, `pipecat`, `vapi`, `deepgram` | target provider; only LiveKit and Pipecat emit runnable projects today |
...
`endpoint_env`. See [regional infrastructure](/models/regional-infrastructure)
