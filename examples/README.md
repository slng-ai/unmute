...
| [`salon-concierge`](salon-concierge/) | Four agents, tasks, a task group, handoffs, local SQLite, MCP, tracing, and inbound phone routes | **Release-readiness example.** Verify once, manage stored bookings, answer or escalate complaints, cold-transfer to a manager, research current questions through Firecrawl, and inspect Langfuse traces. Browser and inbound phone, both code targets, no outbound. |
