...
There is one more existing line, kept: when the room holds no phone caller, the tool
returns and says so to the model. That path writes no new line, because line 1 plus the
absence of line 2 already says it.
