...
Dependency order: T1, T2 → T3 → T4, T5, T6 → T7 → T8. T9 with T3 (entrypoint template); T10 after T4 + T9 and after compiler.md T11 scaffolds the source package. T11 after T9.
