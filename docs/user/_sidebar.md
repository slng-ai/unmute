...
- Start
  - [What is Unmute](start/what-is-unmute.md)
  - [Install](start/install.md)
  - [Build your first YAML package](start/first-agent.md)

- Learn
  - [01. One agent](learn/01-one-agent.md)
  - [02. Add a tool](learn/02-add-a-tool.md)
  - [03. Variables](learn/03-variables.md)
  - [04. Two agents](learn/04-two-agents.md)
...
- Concepts
  ...
  - [Tags and gating](concepts/tags-and-gating.md)
  - [Tiers](concepts/tiers.md)

- Reference
  - [agent.yaml](reference/agent-yaml.md)
  - [targets.yaml](reference/targets-yaml.md)
  - [tools/*.yaml](reference/tools.md)
  - [agents](reference/agents.md)
  - [tasks and task_groups](reference/tasks.md)
